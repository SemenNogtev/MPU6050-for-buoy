...
MPU6050 accelgyro;
aperiodic Ax_g,Ay_g,Az_g,Gx,Gy,Gz;
...
void setup() {
    ...
    Ax_g.set_values(0.05, 1, 0.01, 0);
    Ay_g.set_values(0.05, 1, 0.01, 0);
    Az_g.set_values(0.05, 1, 0.01, 0);
    Gx.set_values(0.05, 1, 0.01, 0);
    Gy.set_values(0.05, 1, 0.01, 0);
    Gz.set_values(0.05, 1, 0.01, 0);

//// Экспоненциальное бегущее среднее
//    Ax_g.set_values(0.3, 0.0);
//    Ay_g.set_values(0.3, 0.0);
//    Az_g.set_values(0.3, 0.0);
//    Gx.set_values(0.3, 0.0);
//    Gy.set_values(0.3, 0.0);
//    Gz.set_values(0.3, 0.0);
...
void loop() {
    if( millis()-t > T_OUT ){
        ...
        ax_g = Ax_g.aperiodic_solver(ax_g);
        ay_g = Ay_g.aperiodic_solver(ay_g);
        az_g = Az_g.aperiodic_solver(az_g);
        //Serial.print(ax_g);Serial.print("\t");
        //Serial.print(ay_g);Serial.print("\t");
        ...
        gx = Gx.aperiodic_solver(gx);
        gy = Gy.aperiodic_solver(gy);
        gz = Gz.aperiodic_solver(gz);
